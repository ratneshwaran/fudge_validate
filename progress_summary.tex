...
\begin{enumerate}
    \item \textbf{Phase 5 -- Thousand Voices.} Apply LLM \texttt{single\_prompt} + chunked Stage~2 (TV dialogues are 30--100+ turns) to the trauma-therapy corpus. Discrimination question: trauma type (8 classes, balanced).
